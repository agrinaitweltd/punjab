...
/* "Continue with Google" — temporarily disabled on the live site (Google
   ...
   label rather than removed, so the option is easy to switch back on later. */
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          padding: "11px 16px", borderRadius: 12, border: "1.5px solid rgba(0,0,0,0.1)",
          background: "#f3f4f6", color: "#9ca3af", fontWeight: 600, fontSize: 14, cursor: "not-allowed",
        }}
      >
        <svg width="18" height="18" viewBox="0 0 48 48" opacity="0.5">
