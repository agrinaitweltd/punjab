        ...
        {addMode === 'invoice' ? (
          <div className="stack">
            ...
            {invoiceReview && <>
              ...
              {invoiceReview.confidence.invoiceNumber !== 'high' && !invoiceReview.invoice.invoiceNumber && <p className="error-message">Please check the source and enter its invoice number. No number was invented during extraction.</p>}
