        ...
        {detail && (
          <div>
            <div className="ord-review">
              ...
              {detail.originalInvoiceReference && <div className="ord-row"><span>Original Invoice Reference</span><strong>{detail.originalInvoiceReference}</strong></div>}
              {detail.sourceFileName && <div className="ord-row"><span>Source PDF</span><strong>{detail.sourceFileName}</strong></div>}
